...
<div class="flex flex-col pl-5 pr-5 pt-16 pb-32 lg:w-11/12 items-end md:pl-16 md:pr-16">
    <div class="lg:flex lg:mt-20">
        <div class="lg:w-6/12 lg:mr-10 mt-20 lg:mt-0">
            <img class="object-contain drop-shadow-white lg:mt-0" src="https://enhakkore.net/wp-content/uploads/2018/07/CLAVIER-EMPIRE-K300.png" alt="product image">
        </div>
        <div class="lg:w-6/12 flex flex-col justify-between lg:ml-10">
            ...
            <p class="text-4xl text-right mt-10 text-pink-figma">{{ $product->price }}€</p>
        </div>
    </div>
