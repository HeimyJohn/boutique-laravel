        ...
        <form method="POST"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                              value="{{ $updating ? $product->name : old('name') }}"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="price" class="block mt-1 w-full" type="text" name="price"
                              value="{{ $updating ? $product->price : old('price') }}"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="description" class="block mt-1 w-full" type="text" name="description"
                              value="{{ $updating ? $product->description : old('description') }}"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="stock" class="block mt-1 w-full" type="text" name="stock"
                              value="{{ $updating ? $product->stock : old('stock') }}"
